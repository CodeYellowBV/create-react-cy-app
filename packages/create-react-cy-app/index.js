...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// create-react-cy-app is installed globally on people's computers. This means
// that it is extremely difficult to have them upgrade the version and
// because there's only one global version installed, it is very prone to
// breaking changes.
//
// The only job of create-react-cy-app is to init the repository and then
// forward all the commands to the local version of create-react-cy-app.
//
// If you need to add a new command, please add it to the scripts/ folder.
//
// The only reason to modify this file is to add more warnings and
// troubleshooting information for the `create-react-cy-app` command.
//
// Do not make breaking changes! We absolutely don't want to have to
// tell people to update their global version of create-react-cy-app.
//
...
var program = commander
  ...
  .option('--scripts-version <alternative-package>', 'use a non-standard version of react-cy-scripts')
  .allowUnknownOption()
  .on('--help', function () {
    ...
    console.log('      - a custom fork published on npm: ' + chalk.green('my-react-cy-scripts'));
    console.log('      - a .tgz archive: ' + chalk.green('https://mysite.com/my-react-cy-scripts-0.8.2.tgz'));
    console.log('    It is not needed unless you specifically want to use a fork.');
    console.log();
    console.log('    If you have any problems, do not hesitate to file an issue:');
    console.log('      ' + chalk.cyan('https://github.com/CodeYellowBV/create-react-cy-app/issues/new'));
    console.log();
  })
  .parse(process.argv);
...
function createApp(name, verbose, version, template) {
  ...
  console.log('Installing ' + chalk.cyan('react-cy-scripts') + '...');
  console.log();
...
function getInstallPackage(version) {
  var packageToInstall = 'react-cy-scripts';
