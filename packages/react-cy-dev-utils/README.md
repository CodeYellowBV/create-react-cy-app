...
This package includes some utilities used by [Create React App](https://github.com/CodeYellowBV/create-react-cy-app).  
...
var InterpolateHtmlPlugin = require('react-cy-dev-utils/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('react-cy-dev-utils/WatchMissingNodeModulesPlugin');
...
var formatWebpackMessages = require('react-cy-dev-utils/formatWebpackMessages');
...
module.exports = {
  ...
  entry: [
    ...
    'react-cy-dev-utils/webpackHotDevClient',
    'src/index'
  ],
  // ...
}
